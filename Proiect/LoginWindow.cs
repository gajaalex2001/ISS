            ...
            else
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        {
                            ManageAccountsWindow admin = new ManageAccountsWindow(srv, em, this);
                            admin.Show();
                            this.Hide();
                        }
                        else if (em.Type == EmployeeType.Programmer) MessageBox.Show("Programmer", "Programmer");
                        else MessageBox.Show("Tester", "Tester");
                    }
                }
                catch (Exception ex)
                {
